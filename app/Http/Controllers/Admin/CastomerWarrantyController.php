...
class CastomerWarrantyController extends Controller
{
    ...
    public function downloadCertificate(Request $request)
    {
        ...
        $pdf = PDF::loadView('certificate.certificate_' . $data->warranty_type, compact('customer', 'inspection', 'phase_one', 'phase_two'))->setPaper('letter', 'landscape')->setWarnings(false);
